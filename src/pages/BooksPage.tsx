        ...
        <div className="flex flex-col gap-x-[34px] gap-y-[30px] px-[42px] pt-[30px] xl:flex-row xl:gap-y-0 2xl:flex-row 2xl:gap-y-0">
          ...
          {results.isSuccess && (
            <div className="flex w-full flex-col items-center">
              {list ? (
                <main className="flex min-h-screen w-full flex-col flex-wrap gap-x-[105px] gap-y-[30px] lg:gap-x-[34px] xl:gap-x-[25px] 2xl:gap-x-[34px] justify-center">
                ...
                <main className="flex min-h-screen w-full flex-wrap gap-x-[105px] gap-y-[30px] lg:gap-x-[34px] xl:gap-x-[25px] 2xl:gap-x-[33px] justify-center">
                  {results.data.books.map((book: IBook) => (
                    <BookElementTiles
                      key={book._id}
                      author={book.authors}
