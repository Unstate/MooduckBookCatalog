...
const UserPage = () => {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-mooduck-white py-[21px] lg:w-[990px] 2xl:w-[1400px]">
      <Layout>
        <main className="flex flex-col gap-y-[30px] px-[42px] py-[21px]">
          ...
          <div className="flex flex-col gap-y-[30px]">
            ...
            <div className="flex flex-wrap justify-center gap-x-[106px] gap-y-[30px] md:gap-x-[106px] lg:gap-x-[153px] 2xl:gap-x-[79px]">
              {userFavoriteBooks ? (
