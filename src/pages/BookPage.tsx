...
const BookPage = () => {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-mooduck-white py-[21px] lg:w-[990px] xl:w-[1400px] 2xl:w-[1400px]">
      <Layout>
        <main className="min-h-screen w-full flex-col gap-y-[30px] px-[42px] pt-[30px]">
          ...
          <section className="flex w-full flex-col gap-y-5 py-[30px]">
            <div className="flex items-center justify-between flex-wrap gap-y-[10px]">
              ...
              <MyButton
                className="2xl:w-[250px] xl:w-[250px] lg:w-[250px] md:w-[250px] w-full py-4"
